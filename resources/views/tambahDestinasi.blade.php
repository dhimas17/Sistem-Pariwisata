      ...
      <div class="slider-item" style="background-image: url(images/bg_1.jpg);">
        ...
        <div class="container">
          <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
            ...
            <span class="subheading" style="color:white">Tambah Destinasi</span>
              ...
              <form action="/tambah" method="post" enctype="multipart/form-data">
                  ...
                  <label>
                    <br>
                    {{csrf_field()}}
                    <input type="submit" value="Tambah Destinasi" class="btn btn-primary btn-white btn-outline-white p-6 px-xl-7 py-xl-6">
                  </label>
              </form>
            </div>
          </div>
