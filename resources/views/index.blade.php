        ...
        <div class="container">
          <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
            <div class="col-md-8 col-sm-12 text-center ftco-animate">
            	<span class="subheading" style="color:white">Selamat Datang</span>
              ...
              <p><a href="/adminLogin" class="btn btn-primary btn-white btn-outline-white p-3 px-xl-3 py-xl-3" >Admin</a>
                 <a href="/customerLogin" class="btn btn-white btn-outline-white p-3 px-xl-4 py-xl-3">Customer</a>
              </p>
            </div>
          </div>
        </div>
