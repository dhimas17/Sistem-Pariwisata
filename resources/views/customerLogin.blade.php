      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
          <ul class="navbar-nav ml-auto">       
            <li class="nav-item"><a href="/customerRegister" class="nav-link">Register</a></li>
          ...
          <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
            <div class="col-md-8 col-sm-12 text-center ftco-animate">
              ...
              <form action="/loginCustomer" method="post">
                  ...
                  <br>
                  <label>
                    <a class = "p-6 px-xl-7 py-xl-6">Password</a>
                    <br>
                    <input type="password" name="password" required>
                  </label>
                  <br>
                  {{@csrf_field()}}
                  <input type="submit" value="Login" class="btn btn-primary btn-white btn-outline-white p-6 px-xl-7 py-xl-6">
              </form>
            </div>
          </div>
        </div>
